        ...
        <form action="index.php" method="post">
            ...
            <div class="event-title">
                <div class="title-text">
                    ...
                    <p>Eventi / <input required name="nome" type="text" maxlength="100"
                            value="<?php echo $event["nameCd"] ?>"></p>
                    </div>
            ...
            <div class="event-info">
                ...
                <div class="event-loc">
                    ...
                    <input required name="pos" type="text" maxlength="100"value="<?php echo $event["locationCd"] ?>">
            </div>
            </div>
            <textarea name="descrizione" class="event-desc" maxlength="255"
                placeholder="Descrizione dell'evento"><?php echo $event["descCd"] ?></textarea>
            </div>
        </form>
    <div class="event-main">
