...
<input type="text" name="piva" id="" placeholder="P. IVA*" required>
...
<input type="text" name="prov" id="" placeholder="Provincia*" required>
<input type="text" name="username" id="" placeholder="Username*" required>
<input type="email" name="email" id="" placeholder="Email*" required>
<input type="text" name="nomeRef" id="" placeholder="Nome Referente*" required>
<input type="text" name="cognomeRef" id="" placeholder="Cognome Referente*" required>
