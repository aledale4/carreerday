<?php
    ...
    if (mysqli_num_rows($result) == 0) exit(0);
...
<div class="event">
    <div class="event-title">
        ...
        <a href="<?php echo 'index.php?pag=edit_event&id='.$id?>"><span class="material-symbols-outlined">edit</span></a>
    </div>
    <div class="event-info">
        <p class="event-date"><?php echo date_format(date_create($event["dateCd"]),"d F Y");  ?> / <?php echo date_format(date_create(datetime: $event["fromCd"]),"H:i");  ?> - <?php echo date_format(date_create(datetime: $event["toCd"]),"H:i");  ?></p>
