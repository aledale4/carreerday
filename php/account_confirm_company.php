...
function generateWelcomeEmail($ragsoc) {
    ob_start();
?>
...
<body>
    <div class="reset-pwd-email-container">
        ...
        <h1>Account creato con successo</h1>
        <p>Benvenuto in CareerDay, <strong><?php echo $ragsoc; ?></strong></p>
        <p>Siamo lieti della tua partecipazione al progetto.</p>
