    ...
    <div class="event">
        ...
        <form action="index.php" method="post">
            <div class="event-data-inputs">
                ...
                <p>Nome dell'evento: <input maxlength="100" type="text" name="nome" id="" placeholder="" required></p>
                ...
                <p>Luogo: <input maxlength="100" type="text" name="pos" id="" placeholder="" required></p>
